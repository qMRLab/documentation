...
.. raw:: html
	...
	</p><h2 id="30">5. Notes</h2><h2 id="31">5.a. Notes specific to <tt >b1_afi</tt></h2><h2 id="32">5.a.1 BIDS</h2><p >
	...
	|-------------- sub-01_TB1map.json
	</pre><p >For further information, please visit <a href="https://bids-specification.readthedocs.io/en/stable/99-appendices/11-qmri.html">BIDS qMRI Appendix</a>.</p><h2 id="34">5.b. Generic notes</h2><h2 id="35">5.b.1. Batch friendly <tt >option</tt> and <tt >protocol</tt> conventions</h2><p >If you would like to load a desired set of <tt >options</tt> / <tt >protocols</tt> programatically, you can use <tt >*.qmrlab.mat</tt> files. To save a configuration from the <tt >protocol</tt> panel of <tt >b1_afi</tt>, first open the respective panel by running the following command in your MATLAB command window (MATLAB only):</p><pre class="language-matlab">Custom_OptionsGUI(b1_afi);
	...
	</p><h2 id="39">5.b.2 Parallelization:</h2><p >
	<div class="danger">
	...
	</p><h2 id="41">6. Citations</h2><p ><b >qMRLab JOSS article</b></p><p >
