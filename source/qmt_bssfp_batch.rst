...
.. raw:: html
	...
	</pre><p ><img vspace="5" hspace="5" src="https://github.com/qMRLab/doc_images/blob/main/usr/protPanels/qmt_bssfp.png?raw=true" alt=""> </p><p ><i >If available, you need to close this panel for the remaining of the script to proceed.</i></p><p >
	<div class="warning">
	...
	</pre><img vspace="5" hspace="5" src="_static/qmt_bssfp_batch_03.png" alt=""> <h2 id="28">4.b. <tt >Sensitivity Analysis</tt></h2><p >
	<details >
	...
	</p><pre >            F             kr            R1f           R1r           T2f           M0f</pre><pre class="codeinput">      OptTable.st = [0.1           30            1             1             0.04          1]; <span class="comment">% nominal values</span>
	...
	</pre><img vspace="5" hspace="5" src="_static/qmt_bssfp_batch_04.png" alt=""> <h2 id="30">5. Notes</h2><h2 id="31">5.a. Notes specific to <tt >qmt_bssfp</tt></h2><p >
	...
	</p><h2 id="32">5.b. Generic notes</h2><h2 id="33">5.b.1. Batch friendly <tt >option</tt> and <tt >protocol</tt> conventions</h2><p >If you would like to load a desired set of <tt >options</tt> / <tt >protocols</tt> programatically, you can use <tt >*.qmrlab.mat</tt> files. To save a configuration from the <tt >protocol</tt> panel of <tt >qmt_bssfp</tt>, first open the respective panel by running the following command in your MATLAB command window (MATLAB only):</p><pre class="language-matlab">Custom_OptionsGUI(qmt_bssfp);
