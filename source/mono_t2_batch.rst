...
.. raw:: html
	...
	</pre><img vspace="5" hspace="5" src="_static/mono_t2_batch_03.png" alt=""> <h2 id="28">4.b. <tt >Sensitivity Analysis</tt></h2><p >
	<details >
	...
	</pre><img vspace="5" hspace="5" src="_static/mono_t2_batch_04.png" alt=""> <h2 id="30">5. Notes</h2><h2 id="31">5.a. Notes specific to <tt >mono_t2</tt></h2><h2 id="32">5.a.1 BIDS</h2><p >
	...
	|-------------- sub-01_M0map.nii.gz
	|-------------- sub-01_M0map.json
	</pre><p >For further information, please visit <a href="https://bids-specification.readthedocs.io/en/stable/99-appendices/11-qmri.html">BIDS qMRI Appendix</a>.</p><h2 id="34">5.b. Generic notes</h2><h2 id="35">5.b.1. Batch friendly <tt >option</tt> and <tt >protocol</tt> conventions</h2><p >If you would like to load a desired set of <tt >options</tt> / <tt >protocols</tt> programatically, you can use <tt >*.qmrlab.mat</tt> files. To save a configuration from the <tt >protocol</tt> panel of <tt >mono_t2</tt>, first open the respective panel by running the following command in your MATLAB command window (MATLAB only):</p><pre class="language-matlab">Custom_OptionsGUI(mono_t2);
